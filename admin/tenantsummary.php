            ...
            <div class="col-md-6">
                <div class="bg-light-gray p-3 rounded mb-4">
                    ...
                    <?php if (!empty($latest_payment_date)) { ?>
                        <p><strong>Last Payment Date:</strong> <?php echo $latest_payment_date; ?></p>
...
function printTable() {
    ...
    if (table) {
        ...
        printWindow.document.write('<html><head><title>Tenant Table</title></head><body>');
        ...
        printWindow.document.write('</style>');
        printWindow.document.write('<h1 style="text-align: center;">Tenant Summary Reports</h1>');
